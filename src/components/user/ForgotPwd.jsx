...
const ForgotPwd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // const url =
      // "https://e-com-api-pgag.onrender.com/api/v1/user/password/forgot";
      // const url = "http://localhost:5000/api/v1/user/password/forgot";
      const url =
        `${process.env.REACT_APP_DEV_URL}/user/password/forgot` ||
        `${process.env.REACT_APP_PROD_URL}/user/password/forgot`;
